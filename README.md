Il suffit de l'installer sur un serveur exemple : anonyme.com

Puis, On fournit un lien différent à chaque personne (via un réseau social) par exemple : https://anonyme.com/messages.php?user=John

C'est fini ! De temps en temps il faut juste consulter https://anonyme.com/logs.txt
